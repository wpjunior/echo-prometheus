...
// MetricsMiddlewareDefault returns an echo middleware with default config for instrumentation.
func MetricsMiddlewareDefault() echo.MiddlewareFunc {
	return MetricsMiddleware(DefaultConfig)
}

// MetricsMiddleware returns an echo middleware for instrumentation.
func MetricsMiddleware(config Config) echo.MiddlewareFunc {
